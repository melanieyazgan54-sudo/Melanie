...
1. **Gezielt lesen, nie Ordner laden:** Die Referenz-Bibliotheken (`marketingskills/`, `libs/context-engineering/`, `libs/find-skills/`, `libs/ruflo/` – Agenten-Workflow-Muster, siehe dortiger `REFERENZ-HINWEIS.md`) sind zusammen >30 MB. Immer nur die eine benötigte Datei lesen (z. B. eine SKILL.md), niemals ganze Ordner oder README-Ketten. Erst die Pfad-Tabelle oben konsultieren, dann exakt eine Quelle öffnen.
